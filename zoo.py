"""Script that uses inheritance and composition,
simulating a Zoo"""
...
you created above. Once you’ve added them all, you should be able to use zoo.total_of_category( ) 
...
print(zoo.total_of_category("mammal"))
